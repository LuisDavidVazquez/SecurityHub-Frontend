...
const cameraSocket: Socket = io("https://crazy-insects-follow.loca.lt", {
  transports: ["websocket"],
});
...
const Cameras: React.FC = () => {
  ...
  const takePhoto = async () => {
    ...
    const response = await fetch(`https://crazy-insects-follow.loca.lt/take_photo`, { method: 'POST' });
  ...
  const startRecording = async () => {
    ...
    getButtonStop(true)
    await fetch(`https://crazy-insects-follow.loca.lt/start_recording`, { method: 'POST' });
  };

  const stopRecording = async () => {
    getButtonStart(true)
    getButtonStop(false)
    await fetch(`https://crazy-insects-follow.loca.lt/stop_recording`, { method: 'POST' });
    Swal.fire({
